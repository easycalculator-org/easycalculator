...
<div class="tz-widget">
    ...
    <div class="tz-result">
        ...
        <span id="tzSelectedFrom"
              class="tz-result-time pacific-result">
            PST --
        </span>
        ...
        <span id="tzSelectedTo"
              class="tz-result-time india-result">
            IST --
        </span>
...
<script src="{{ '/assets/js/time/pst-to-ist.js' | relative_url }}"></script>
