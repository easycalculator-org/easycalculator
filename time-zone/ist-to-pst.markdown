---
layout: default
title: IST to PST Converter – India Standard Time to Pacific Time
permalink: /ist-to-pst
description: "Convert IST to PST quickly with our free time zone converter. Find the time difference between India Standard Time and Pacific Time and easily convert dates and times."
image: "/assets/images/og/ist-to-pst-icon.jpg"
...
<div aria-label="breadcrumb" class="p-3"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="/">Home</a></li><li class="breadcrumb-item"><a href="/time-zone-converter">Time Zone </a></li><li class="breadcrumb-item active" aria-current="page">IST to PST Time Converter </li></ol></div>
...
<script src="{{ '/assets/js/time/ist-to-pst.js' | relative_url }}"></script>
