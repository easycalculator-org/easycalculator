...
permalink: /pst-to-est
description: "Convert PST to EST quickly with our free time zone converter. Find the time difference between Pacific Time and Eastern Time and easily convert dates and times."
image: "/assets/images/og/pst-to-est-icon.jpg"
...
<div aria-label="breadcrumb" class="p-3"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="/">Home</a></li><li class="breadcrumb-item"><a href="/time-zone-converter">Time Zone </a></li><li class="breadcrumb-item active" aria-current="page">PST to EST Time Converter </li></ol></div>
...
<script src="{{ '/assets/js/time/pst-to-est.js' | relative_url }}"></script>