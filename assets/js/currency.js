...
const currencyMap = {
    ...
    XAF: { country: "CEMAC", code: "xaf" },
    XCD: { country: "Organisation of Eastern Caribbean States", code: "xcd" },
    XDR: { country: "International Monetary Fund", code: "xdr" },
    XOF: { country: "CFA", code: "xof" },
    XPF: { country: "Collectivités d'Outre-Mer", code: "xpf" },
