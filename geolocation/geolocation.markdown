...
<div class="col-md-3  p-3  "><a class="text-decoration-none" href="/azimuth-calculator"><div class="calculator-box text-center"><i class="fa-solid  fa-route fa-xl"></i><h5>Azimuth Calculator</h5></div></a></div>
<div class="col-md-3  p-3  "><a class="text-decoration-none" href="/geolocation-tools/distance-calculator-on-map"><div class="calculator-box text-center"><i class="fa-solid fa-magnifying-glass-location fa-xl"></i><h5>Distance Calculator on Map</h5></div></a></div>
<div class="col-md-3  p-3  "><a class="text-decoration-none" href="/map-radius"><div class="calculator-box text-center"><i class="fa-solid fa-map fa-xl"></i><h5>Map Radius</h5></div></a></div>
 </div>
