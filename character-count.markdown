...
<div class="stat-card card text-info-emphasis bg-light border-0 rounded-3 p-4">
 <h3 class="h5"><i class="fa-solid fa-chart-line"></i>Readability</h3>
           <ul class="list-unstyled">
 ...
 <button class="btn btn-outline-primary" onclick="copyText()"><i class="fa-solid fa-copy"></i> Copy Text</button>
